...
def getUrls():
    ...
    url = r"http://image.baidu.com/search/flip?tn=baiduimage&ie=utf-8&word=女生头像欧美&pn={pn}"
    urls = (url.format(pn=x) for x in count(start=2, step=60))
    return urls


dirpath = '/Users/danny/PycharmProjects/spider/' + 'WesternProfileWoman'
...
for url in urls:
    ...
    for pic_url in pic_urls:
        print 'Downloading: ' + str(index) + ' image, address:' + str(pic_url)
