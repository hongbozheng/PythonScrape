...
folder = 'blackpeoplemeetManUSA' + str(s_age) + '-' + str(e_age)
index = 45303
uniqueIndex = 11247
states = [ "US-AK", "US-AL",
                      "US-AR",
...
def getUrls():
    url = "https://www.blackpeoplemeet.com/v3/search/results?start={pn}&sortCol=MyDefault&DisplayResultsStyle=true"
